...
<body>
    ...
    <div class="row">
        <div class="col-sm-4">
         ...
         <div class="col-sm-4">
             <h5><a href="https://goo.gl/maps/VBXaF1ER1Yde8soD6">219 S Washington St, Stillwater, OK 74074</a> <br /> Phone: <a href="tel:405-533-3900">405-533-3900</a></h5>
        </div>
         <div class="col-sm-4">
        </div>
    </div>
        ...
        <div class="col-sm-4">
         ...
         <div class="col-sm-4">
             <h5>  Mon-Sat: 9am-9pm Sun: 12pm-5pm </h5>
        </div>
         <div class="col-sm-4">
        </div>
    </div>
    <div id="form">
            ...
            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfOkhEoxtCbrTm4U0WP9lDW8n43FgqKU6ougy0u-dUwJG_Cfg/viewform?embedded=true" width="640" height="777" frameborder="5" marginheight="0" marginwidth="0">Loading…</iframe>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">      
            <p class="text-justify"> <br /> <i> All of us at Hello Gorgeous </i> are working hard to provide our clients with the latest trendy hair styles, the most enjoyable mani-pedi duo's, the most relaxing facials and massages, and the most precise body waxing!</p>
          </div>
          <div class="col-xs-6 col-md-3">
            <h6>Categories</h6>
            <ul class="footer-links">
              <li><a href="ServicesPage.aspx#pills-bread">Men's Haircut</a></li>
              <li><a href="ServicesPage.aspx#pizza">Women's Haircut</a></li>
              <li><a href="ServicesPage.aspx#pills-burger">Kid's Services</a></li>
              <li><a href="ServicesPage.aspx#pills-chicken">Wedding Packages</a></li>
            </ul>
          </div>
          <div class="col-xs-6 col-md-3">
            <h6>Quick Links</h6>
            <ul class="footer-links">
              ...
              <li><a href="ContactUs.aspx">Contact Us</a></li>
              <li><a href="ServicesPage.aspx">Services</a></li>
              <li><a href="StaffPage.aspx">Our Staff</a></li>
            </ul>
          </div>
        </div>
        <hr>
      ...
      <div class="container">
        <div class="row">
         ...
         <a href="Homepage.aspx">Hello Gorgeous </a>LLC.
            </p>
          </div>
        </div>
      </div>
